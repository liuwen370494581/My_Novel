...
import com.example.ruolan.letgo.Base.App;
...
public class ReadBookControl {
    ...
    private ReadBookControl(){
        if(null == textKind){
            ...
            temp1.put("textExtra", DensityUtil.dp2px(App.getInstance(),6.5f));
            textKind.add(temp1);

            Map<String,Integer> temp2 = new HashMap<>();
            temp2.put("textSize", 16);
            temp2.put("textExtra", DensityUtil.dp2px(App.getInstance(),8));
            textKind.add(temp2);

            Map<String,Integer> temp3 = new HashMap<>();
            temp3.put("textSize", 17);
            temp3.put("textExtra", DensityUtil.dp2px(App.getInstance(),9));
            textKind.add(temp3);

            Map<String,Integer> temp4 = new HashMap<>();
            temp4.put("textSize", 20);
            temp4.put("textExtra", DensityUtil.dp2px(App.getInstance(),11));
            textKind.add(temp4);

            Map<String,Integer> temp5 = new HashMap<>();
            temp5.put("textSize", 22);
            temp5.put("textExtra", DensityUtil.dp2px(App.getInstance(),13));
            textKind.add(temp5);
        }
        if(null == textDrawable){
            ...
            temp2.put("textBackground",R.mipmap.bg_readbook_yellow);
            textDrawable.add(temp2);

            Map<String,Integer> temp3 = new HashMap<>();
            temp3.put("textColor",Color.parseColor("#22482C"));
            temp3.put("textBackground",R.mipmap.bg_readbook_green);
            textDrawable.add(temp3);

            Map<String,Integer> temp4 = new HashMap<>();
            temp4.put("textColor",Color.parseColor("#808080"));
            temp4.put("textBackground", R.mipmap.bg_readbook_black);
            textDrawable.add(temp4);
        }
        preference = App.getInstance().getSharedPreferences("CONFIG", 0);
